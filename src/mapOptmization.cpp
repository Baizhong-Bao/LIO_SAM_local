...
public:
    ...
    // 发布语义点云
    ros::Publisher pubCloudRegisteredSemantic;
    ...
    // 当前激光帧语义点集合
    pcl::PointCloud<PointType>::Ptr laserCloudsemanticLast;
    ...
    */
    mapOptimization()
    {
        ...
        pubCloudRegisteredSemantic = nh.advertise<sensor_msgs::PointCloud2>("lio_sam/mapping/semantic_registered", 1);
    ...
    */
    void allocateMemory()
    {
        ...
        laserCloudsemanticLast.reset(new pcl::PointCloud<PointType>());
 ...
 /**
    ...
    */
    ...
    void laserCloudInfoHandler(const lio_sam::cloud_infoConstPtr& msgIn)
    {
        ...
        pcl::fromROSMsg(msgIn->cloud_semantic, *laserCloudsemanticLast);


        std::lock_guard<std::mutex> lock(mtx);
        // std::cout << laserCloudsemanticLast->points.size() << std::endl;
        // publishCloud(pubCloudRegisteredSemantic, laserCloudsemanticLast, timeLaserInfoStamp, odometryFrame);
    ...
    */
    void publishFrames()
    {
        ...
        // 发布语义点云
        if (pubCloudRegisteredSemantic.getNumSubscribers() != 0)
        {
            PointTypePose thisPose6D = trans2PointTypePose(transformTobeMapped);
            pcl::PointCloud<PointType>::Ptr cloudSemanticOut(new pcl::PointCloud<PointType>());
            *cloudSemanticOut += *transformPointCloud(laserCloudsemanticLast, &thisPose6D);
            publishCloud(pubCloudRegisteredSemantic, cloudSemanticOut, timeLaserInfoStamp, odometryFrame);
        }
